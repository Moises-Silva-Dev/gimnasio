...
const paymentMethodLabel = computed(() => {
    ...
    return methods[props.userMembership.payment_method] || props.userMembership.payment_method;
});
</script>
            ...
            <CardBox>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-700">{{ userMembership.membership?.description }}</p>
                    </div>
            ...
            <CardBox>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <label class="text-sm font-medium text-blue-700">Días Restantes</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600">
                        ${{ parseFloat(userMembership.payment_amount).toFixed(2) }}
                    </p>
                </div>
