...
class PermisosSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'user-memberships.index', 'guard_name' => 'web', 'description' => 'Leer Registros', 'module_key' => 'roles']);
        Permission::create(['name' => 'user-memberships.store','guard_name' => 'web', 'description' => 'Crear Registros', 'module_key' => 'roles']);
        Permission::create(['name' => 'user-memberships.update','guard_name' => 'web', 'description' => 'Actualizar Registros', 'module_key' => 'roles']);
        Permission::create(['name' => 'user-memberships.delete', 'guard_name' => 'web', 'description' => 'Eliminar Registros', 'module_key' => 'roles']);
